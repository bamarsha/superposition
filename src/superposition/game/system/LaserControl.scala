...
import superposition.game.system.LaserControl._
import superposition.math.Vector2i
import superposition.quantum.{StateId, Universe}

import scala.Function.const

final class LaserControl extends IteratingSystem(Family.all(classOf[Beam], classOf[Quantum]).get) {
